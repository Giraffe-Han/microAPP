...
const packageData = {
  'study-198': {
    ...
    intro: '走进无人机研学实践中心，通过展厅参观讲解、课程科普、无人机拼搭与无人机试飞四大环节，让青少年在半天时间内系统了解无人机基础知识，亲手体验无人机组装与飞行的乐趣，激发对低空科技的探索热情。',
    schedule: [
      { amTime: '09:00', pmTime: '14:00', name: '签到集合', desc: '研学中心集合，领取学习资料与活动手册' },
      { amTime: '09:15', pmTime: '14:15', name: '展厅参观讲解', desc: '参观无人机研学实践中心展厅，了解低空科技发展历程' },
      { amTime: '09:50', pmTime: '14:50', name: '课程科普', desc: '无人机飞行原理、安全知识及行业应用场景科普讲解' },
      { amTime: '10:30', pmTime: '15:30', name: '无人机拼搭', desc: '在导师指导下动手拼搭组装无人机，了解机体结构' },
      { amTime: '11:10', pmTime: '16:10', name: '无人机试飞', desc: '在专业导师指导下完成无人机试飞体验' },
      { amTime: '11:30', pmTime: '16:30', name: '结业总结', desc: '成果展示、颁发结业证书、合影留念' }
    ],
    highlights: [
      { emoji: '🏛️', name: '展厅参观讲解', desc: '沉浸式低空科技展厅参观' },
      { emoji: '📚', name: '课程科普', desc: '从原理到应用的系统科普' },
      { emoji: '🔧', name: '无人机拼搭', desc: '亲手组装体验机体结构' },
      { emoji: '🚁', name: '无人机试飞', desc: '导师指导完成真机试飞' }
    ],
    audience: [
      '6-16 岁青少年',
      '对无人机/航空科技有兴趣的学生',
