    ...
    <view class="home-page">
      ...
      <view class="header-section float-header">
        <view class="location-bar">
          ...
          <view class="weather-info">20°C 晴</view>
        </view>
      ...
      <view class="content-area">
        <view class="banner-section">
          <swiper class="banner-swipe" autoplay interval="5000" circular>
...
const quickServices = ref([
  ...
  { id: 10, name: '二手交易', icon: '/static/icons/exchange.svg', color: 'linear-gradient(135deg, #fbbf24 0%, #ea580c 100%)' },
  { id: 11, name: '金融服务', icon: '/static/icons/finance.svg', color: 'linear-gradient(135deg, #6366f1 0%, #a855f7 100%)' },
  { id: 12, name: '维修服务', icon: '/static/icons/maintenance.svg', color: 'linear-gradient(135deg, #38bdf8 0%, #3b82f6 100%)' },
...
const displayServices = ref([
  {
    id: 1,
    name: '无人机物流',
    description: '城市极速配送，解决最后一公里难题',
    icon: '/static/icons/logistics-drone.svg',
    color: 'linear-gradient(135deg, #06b6d4 0%, #2563eb 100%)'
  },
  {
    id: 2,
    name: '政务服务',
    description: '高效环保监测、交通疏导、安全巡查',
    icon: '/static/icons/government.svg',
    color: 'linear-gradient(135deg, #6366f1 0%, #a855f7 100%)'
  },
  {
    id: 3,
    name: '无人机托管',
    description: '专业机库托管，定期维护保养',
  ...
  },
  {
    id: 4,
    name: '无人机吊运',
    description: '建筑材料、基站设备高空精准吊运',
    icon: '/static/icons/lifting.svg',
...
const banners = ref([
  ...
  },
  {
    ...
    link: '/pages/cases/detail?id=1'
  },
  {
    image: 'https://images.unsplash.com/photo-1506947411487-a56738267384?auto=format&fit=crop&w=1000&q=80',
    link: '/pages/cases/detail?id=2'
  }
])
...
const goToDetail = (id) => {
  uni.showToast({ title: `服务 ${id} 开发中`, icon: 'none' })
}
